  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <Button className="bg-[#1e2a3b] text-white"  size="sm">
      ...
      <Card className="bg-[#1e2a3b]">
        <CardHeader>
          <CardTitle className="text-white">Track & Manage</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="mb-6 text-[#ffffff90]">
